...
export async function getFile(id){const doc=await documentRepository.getById(id);if(!doc)return null;const blob=await documentFileService.getBlob(doc);return blob?{id,blob,file_path:doc.file_path,revision:doc.revision,downloaded_at:null}:null}
