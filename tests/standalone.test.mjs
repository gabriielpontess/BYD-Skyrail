...
assert.match(sw,/const VERSION='1\.1\.7'/);assert.match(sw,/systems\.css/);assert.match(sw,/systems-ux\.js/);assert.doesNotMatch(sw,/l17-ouro-hero\.svg/);assert.match(sw,/byd-skyrail-/);
